    ...
    const services = [
        {
            ...
            category: client_1.ServiceCategory.INDIVIDUAL,
            description: 'Non-clinical, trauma-aware, coaching-based support for individuals seeking to strengthen communication, emotional regulation, leadership skills, and workforce readiness.',
            priceMin: 99,
            priceMax: 150,
            durationMin: 60,
        ...
        },
        {
            ...
            category: client_1.ServiceCategory.FAMILY,
            description: 'Trauma-aware, coaching-based support for parents and caregivers focused on communication, connection, problem-solving, and resilience.',
            priceMin: 99,
            priceMax: 150,
            durationMin: 60,
            unitLabel: 'per person',
        ...
        },
        {
            ...
            category: client_1.ServiceCategory.ORGANIZATIONAL,
            description: 'Coaching to strengthen professional communication, reduce misunderstandings/conflict, and build clarity, confidence, and emotional regulation.',
            priceMin: 650,
            priceMax: 1000,
            durationMin: 60,
            unitLabel: 'per person',
        ...
        },
        {
            ...
            category: client_1.ServiceCategory.ORGANIZATIONAL,
            description: 'Coaching for accountability, time management/executive functioning, workplace etiquette/boundaries, and navigating feedback.',
            priceMin: 600,
            priceMax: 950,
            durationMin: 60,
            unitLabel: 'per person',
        ...
        },
        {
            ...
            category: client_1.ServiceCategory.ORGANIZATIONAL,
            description: 'Trauma-aware leadership coaching to strengthen communication, delegation, decision-making, confidence, and reduce reactive leadership patterns.',
            priceMin: 850,
            priceMax: 1500,
            durationMin: 60,
        ...
        },
        {
            ...
            category: client_1.ServiceCategory.ORGANIZATIONAL,
            description: 'Team sessions to improve cohesion, address communication breakdowns, strengthen trust, and support morale/culture.',
            priceMin: 1500,
            priceMax: 3000,
            durationMin: 90,
        ...
        },
        {
            ...
            category: client_1.ServiceCategory.ORGANIZATIONAL,
            description: 'Coaching to prepare employees for advancement by strengthening adaptability, reliability, workplace presence, emotional intelligence, and self-management.',
            priceMin: 650,
            priceMax: 1200,
            durationMin: 60,
            unitLabel: 'per person',
        ...
        },
        {
            ...
            category: client_1.ServiceCategory.ORGANIZATIONAL,
            description: 'Support to identify communication patterns affecting performance, coach teams through change/stress/conflict, and build healthier workplace norms.',
            priceMin: 2000,
            priceMax: 4500,
            durationMin: 90,
